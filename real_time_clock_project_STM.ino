...
#define KEY_READ_INTERVAL      200   // Key read interval put as macro. Experiment with duration

 // RTC modes put as macro.
#define NORMAL_MODE   0
#define EDIT_MODE     1

LiquidCrystal lcd(12, 11, 5, 4, 3, 2);     // Intializing the LCD with arduino's pins associated  to the project.
...
bool ToggleVal=LOW;     // Global Variables for testing time update interval
int Mode;      // Global Variables for RTC mode
int Xpos;     // Global Variables for LCD cursor  position
int KeyVal=-1;      // Global Variables for key value
